    ...
    <div className="flex flex-col max-w-4xl mx-auto w-full pt-8 md:pt-20 px-0">
      ...
      <div className="mb-14 space-y-8 animate-fade-in-up">
        ...
        <div className="flex flex-wrap gap-4 pt-2">
           ...
           <Link href="/projects" className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-zinc-800 hover:bg-zinc-700 text-zinc-200 border border-zinc-700 transition-all">
             Projects completed
           </Link>
        </div>
      </div>
